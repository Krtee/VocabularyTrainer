        ...
        <div className="row">
          <Navbar bg="light" expand="lg" id="navbar">
            <Navbar.Brand href="#home">
              <span className="bigFont">VTrainer</span>
            </Navbar.Brand>
            <Navbar.Toggle aria-controls="basic-navbar-nav" />
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="mr-auto">
                <Nav.Link href="#link" className="menu_option" onClick={this.chooseVocabularyList}>
                  Vocabulary overview
                </Nav.Link>
                <Nav.Link href="#link" className="menu_option" onClick={this.chooseAddVocabulary}>
                  Add vocabulary
                </Nav.Link>
                <Nav.Link href="#link" className="menu_option" onClick={this.chooseTrainVocabulary}>
                  Train vocabulary
                </Nav.Link>
                <NavDropdown title="Other" id="basic-nav-dropdown" className="menu_option">
