        ...
        <div id="content" className="vocabulary_list">
          ...
          <div id="vocabulary_list">
            ...
            <div className="row vocabulary_list_entry">
              ...
              <div className="col-xl-2 col-lg-2 col-md-3 col-4 vocabulary_list_header">
                {langName}
              </div>
              <div className="col-xl-1 col-lg-2 col-md-3 col-4 vocabulary_list_header">
                Progress
              </div>
            </div>

            {creating && currentVocabs.length === 0 ? (
              <p className="mt-5">
                <span className="creating">Your new workspace is being created</span>
              </p>
            ) : (
              ""
            )}
            ...
            <Pagination
              vocabsPerPage={vocabsPerPage}
              totalVocabs={prog.length}
              paginate={paginate}
            />
          </div>
        </div>
